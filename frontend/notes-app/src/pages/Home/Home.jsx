...
import AddNotesImg from "../../assets/images/icons8-note-64.png";
import NoDataImg from "../../assets/images/icons8-no-data-availible-24.png";
...
const Home = () => {
  ...
  const getAllNotes = async () => {
    try {
      ...
      if (response.data?.notes) {
        ...
        console.log("Failed to fetch notes. No notes found.");
      }
    } catch (error) {
      console.error(
  ...
  return (
    <>
      ...
      <Toast
        isShown={showToastMsg.isShown} // Correct state object
